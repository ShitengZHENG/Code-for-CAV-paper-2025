function [no_platLeader,vdata,xdata,adata,acmd]=fun_SimMultiPlatoon_npre3(data_Input,para_AV,paraUpper,LowLevelModel_label,NoiseStrength,platsize)
...
for t=1:step-1
    ...
    for nj=2:nveh
        ...
        elseif j==3
            ...
            dx_desired=Tg_*vdata(t,nj)+Gmin;
            acmd(t+1,nj)=ka3_*acmd(t-dd,nj-3)+ka2_*acmd(t-dd,nj-2)+ka1_*acmd(t-dd,nj-1)+...
                kv3_*dv3(nj)+kv2_*dv2(nj)+kv1_*dv1(nj)+...
                kg_*(dx(nj)-dx_desired);
        end
