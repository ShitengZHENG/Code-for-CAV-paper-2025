...
data_targetLaneID=nan(total_nveh,1);
data_initLaneID=nan(total_nveh,1);
...
for t=1:step
    ...
    for kj=1:nveh
        ...
        data_initLaneID(nokj_)=veh_status(kj).initial_lane;
        data_targetLaneID(nokj_)=veh_status(kj).path;
